...
|`power.roll.dice.mode`|When the number of dice is more than 2, set to `kh` or `kl` to detemine if Keep Highest 2 or Keep Lowest 2 should be used. `kh` is the default.|
